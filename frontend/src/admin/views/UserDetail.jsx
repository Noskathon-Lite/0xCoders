                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-4">
                            ...
                            {voter.citizenship_photo_back ? (
                                <img src={voter.citizenship_photo_back} alt="Back Photo" className="w-full max-w-xs mb-4" />
                            ) : (
                            ...
                            {voter.citizenship_photo_front ? (
                                <img src={voter.citizenship_photo_front} alt="Front Photo" className="w-full max-w-xs mb-4" />
                            ) : (
                            ...
                            {voter.photo ? (
                                <img src={voter.photo} alt="Profile Photo" className="w-full max-w-xs mb-4" />
                            ) : (
